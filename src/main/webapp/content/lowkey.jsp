...
<div class="bg-image" style="background-image: url('../images/lowkey/01.png'); height: 50vh;">
    <div class="mask" style="background: linear-gradient(
      ...
      hsla(0, 0%, 0%, 1)
        ...
        <footer class="pt-3 ps-4 ms-5 text-white blockquote-footer text-opacity-50">Established 2010
            – Seoul.
        </footer>
        <p class="d-flex pt-4 ps-4 ms-5 text-white w-50">
            로우키는 서울을 기반으로 스페셜티 커피를 다루고 있는 로스터리입니다. <br>
            무엇보다 커피의 품질을 우선으로 생각합니다. 모든 과일이 그렇듯 커피도 제철과일입니다. <br>
            필요한 양만큼만 소량씩 로스팅하여 신선하고 맛이 가장 좋을 때 제공하고자 노력합니다.
        </p>
    </div>
</div>
<%--Header--%>
