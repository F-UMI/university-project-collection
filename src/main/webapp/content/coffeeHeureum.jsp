...
<div class="bg-image" style="background-image: url('../images/heureum/01.png'); height: 50vh;">
    <div class="mask" style="background: linear-gradient(
      ...
      hsla(0, 0%, 0%, 1)
        ...
        <footer class="pt-3 ps-4 ms-5 text-white blockquote-footer text-opacity-50">Established 2019
            – Suwon.
        </footer>
        <p class="d-flex pt-4 ps-4 ms-5 text-white w-50">
            Q-grader 선별 로스팅 / 스페셜티 원두 커피 전문. <br>
            항상 최선으로 최고 퀄리티의 커피에 다가가고자 노력하는 커피흐름 입니다.
        </p>
    </div>
</div>
<%--Header--%>
