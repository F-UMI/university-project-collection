...
<div class="bg-image" style="background-image: url('../images/pastel/01.jpg'); height: 50vh;">
    <div class="mask" style="background: linear-gradient(
      ...
      hsla(0, 0%, 0%, 1)
        ...
        <footer class="pt-3 ps-4 ms-5 text-white blockquote-footer text-opacity-50">Established 2011
            – Seoul.
        </footer>
        <p class="d-flex pt-4 ps-4 ms-5 text-white w-50">
            파스텔커피웍스는 오직 맛있는 커피와 전문가 라는 두 단어에 집중한 커피전문회사입니다.
            우리는 전 세계 커피를 테스팅하며, 섬세한 로스팅 프로파일을 연구합니다.
        </p>
    </div>
</div>
<%--Header--%>
